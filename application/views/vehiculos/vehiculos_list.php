...
<html>
    <head>
        <title>Vehículos en Espera</title>
    ...
    <body>
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <h2 style="margin-top:0px">Lista de Vehiculos Espera</h2>
            </div>
	    ...
	    <tbody>
			...
			<?php 
			echo anchor(site_url('vehiculos/read/'.$vehiculos->idvehiculo ),'Detalles'); 
			echo ' | '; 
            echo anchor(site_url('vehiculos/validar_auto/'.$vehiculos->idvehiculo ),'Validar'); 
            echo ' | '; 
