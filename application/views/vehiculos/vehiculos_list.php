...
<html>
    ...
    <body>
	    ...
	    <tbody>
			...
			<?php 
			echo anchor(site_url('vehiculos/read/'.$vehiculos->idvehiculo ),'Read'); 
			echo ' | '; 
			echo anchor(site_url('vehiculos/update/'.$vehiculos->idvehiculo),'Update'); 
			echo ' | '; 
			echo anchor(site_url('vehiculos/delete/'.$vehiculos->idvehiculo),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
