...
<html>
    ...
    <body>
	    ...
	    <tbody>
			...
			<?php 
			echo anchor(site_url('vehiculos/read_validado/'.$vehiculos->idvehiculo ),'Detalles'); 
			echo ' | '; 
			echo anchor(site_url('vehiculos/update/'.$vehiculos->idvehiculo),'Asignar Concesionario'); 
			echo ' | '; 
